...
class ThermalPrinter(object):
    ...
    def __init__(self, heatTime=100, heatInterval=255, heatingDots=20, serialport=SERIALPORT):
...
"""
    ...
    p.print_img("resource/example.png")
